 ...
 *******************************************************************************/
package com.BC.androidtool.views.pull;
...
import com.BC.androidtool.views.pull.internal.EmptyViewMethodAccessor;
import com.BC.androidtool.views.pull.internal.LoadingLayout;
...
public class PullToRefreshListView extends
	...
	protected class InternalListView extends ListView implements
		...
		public InternalListView(Context context, AttributeSet attrs) {
			...
			final Drawable d = a
					.getDrawable(R.styleable.PullToRefreshListView_divider);
			if (d != null) {
				setDivider(d);
			}
			final int dividerHeight = a.getDimensionPixelSize(
					R.styleable.PullToRefreshListView_dividerHeight, 0);
			if (dividerHeight != 0) {
				setDividerHeight(dividerHeight);
			}
			final boolean scrollbars = a.getBoolean(
					R.styleable.PullToRefreshListView_scrollbars, false);
			if (dividerHeight != 0) {
				setVerticalScrollBarEnabled(scrollbars);
			}
			a.recycle();
		}
