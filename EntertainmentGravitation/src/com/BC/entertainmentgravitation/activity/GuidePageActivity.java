...
import com.BC.entertainmentgravitation.adapter.ViewPagerAdapter;
...
//			iv.setImageResource(pics[i]);
	...
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (currentIndex == 0)
        {
                ...
                {
//                	Log.i("debug", "------------first page position------------" + position);
                }
        }
        else if (currentIndex == pics.length - 1)
        {
                ...
                if (positionOffsetPixels == 0 && currentPageScrollStatus == 1)
                {
//                	Log.i("debug", "------------last page position------------" + position);
