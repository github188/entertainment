...
public class CalendarFragemt extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		contentView = inflater.inflate(R.layout.fragemt_calendar, null);
		return contentView;
	}
	...
	public View newItem(int position) {
		...
		// if (days[position].month == month && sign != null
		// && sign.size() > days[position].dayOfMonth) {
		// if (sign.get(days[position].dayOfMonth).contains(month+"-"+days)) {
		// contentView.findViewById(ids[position]).setBackgroundColor(
		// Color.RED);
		// }
		// }
