...
public class BaseSelectItem extends LinearLayout implements OnClickListener {
	...
	private String equalsString = "其他（可编辑）";
	...
	private void init() {
		...
		contentnLayout = (LinearLayout) inflater.inflate(
				R.layout.layout_base_select_item, null);
		...
		// itemImage = contentnLayout.findViewById(R.id.itemImage);
	...
	WheelInterfasc interfasc = new WheelInterfasc() {
	...
	WheelInterfasc interfasc2 = new WheelInterfasc() {
