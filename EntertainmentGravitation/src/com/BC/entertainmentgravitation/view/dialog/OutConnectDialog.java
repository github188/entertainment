...
public class OutConnectDialog extends Dialog {

	public OutConnectDialog(Context context, boolean cancelable,
			OnCancelListener cancelListener) {
		super(context, cancelable, cancelListener);
		// TODO Auto-generated constructor stub
	}

	public OutConnectDialog(Context context, int theme) {
		super(context, theme);
		// TODO Auto-generated constructor stub
	}

	public OutConnectDialog(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	...
	public static class Builder implements WheelInterfasc {
		...
		public OutConnectDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final OutConnectDialog dialog = new OutConnectDialog(context,
					R.style.Dialog);
			layout = inflater.inflate(R.layout.dialog_connect, null);
