...
public class GiftDialog extends Dialog {
	...
	public GiftDialog(Context context, boolean cancelable,
	...
	public static class Builder implements WheelInterfasc {
		...
		public GiftDialog create() {
			...
			final GiftDialog dialog = new GiftDialog(context, R.style.Dialog);
			layout = inflater.inflate(R.layout.dialog_gift, null);
